...
// const ChipInput = ({label,name,placeholder,register,
...
//     const addtag = (e)=>{
//         console.log(e)
//         if((e.keyCode === 13 || e.keyCode === 32) && tagVal){
//             setTags([...tags,tagVal]);
//             setTagVal("");
//         }
//     }
...
//     const deleteTag = (val)=>{
//       const remainTag = tags.filter((t)=>t!==val);
//       setTags(remainTag);
//     }
...
//     {
//         tags.map((item,index)=>(
//             <div key={index} onClick={()=>deleteTag(item)}>{item} {" "}  
//             </div>
//         ))
//     }
//     </div>
