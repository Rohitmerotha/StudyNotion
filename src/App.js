...
import Instrucor from "./components/core/Dashboard/InstructorDashboard/Instrucor";
function App() {
  // const {user} = useSelector((state)=>state.profile)
  // console.log("ACCOUNT_TYPE",user)
  return (
   <div className="w-screen min-h-screen bg-richblack-900 flex flex-col font-inter">
    ...
    >
      ...
      <Route path="dashboard/instructor" element={<Instrucor />} />
      {/* {
